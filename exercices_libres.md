...
Une solution est de définir un `PrintHex` avec 2 paramètres, le nombre, dans un type quelconque, et le nombre de chiffres à afficher. Il suffit d’ajouter une boucle `for` dans `PrintHex` !
